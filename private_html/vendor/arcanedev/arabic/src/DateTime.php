...
class DateTime implements DateTimeInterface
{
     ...
     * @return string contain date
     */
    public function hijriDate($timestamp = null, $arabicMode = null, $format = null)
    {
     ...
     * @return string
     */
    private function parseFullDate($replace, $format)
    {
        $format = $format?:':title (:time) :period - :dayName :day :monthName , :year';
